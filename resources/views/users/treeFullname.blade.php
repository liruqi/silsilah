...
<div id="wrapper">
    <span class="label">{{ link_to_route('users.tree', $user->fullName(), [$user->id], ['title' => $user->name.' ('.$user->gender.')']) }}</span>
                                    ...
                                    <div class="entry {{ $ggcCount == 1 ? 'sole' : '' }}">
                                        ...
                                        <div class="branch lv5">
                                            ...
                                            <div class="entry {{ $ggccCount == 1 ? 'sole' : '' }}">
                                                <span class="label">{{ link_to_route('users.tree', $ggcc->fullName(), [$ggcc->id], ['title' => $ggcc->name.' ('.$ggcc->gender.')']) }}</span>
                                            </div>
                                            @endforeach
                                        </div>
                                        @endif
